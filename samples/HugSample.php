...
$connectionString = 'DefaultEndpointsProtocol=https;AccountName=hugjanhonzastorage;AccountKey=+9veEiavHjvSOEUC7jdhsun0zAznlANFBucLT6i52yPMZgoEp0bjIuy5PcRgH8mKorlucF11mktyRi5Rit8KIw==';
...
if(isset($_GET['uploadBlobSample'])){
...
if(isset($_GET['downloadBlobSample'])){
...
?>
    ...
    <a href="?createContainer">Create container</a>
    <a href="?uploadBlobSample">uploadBlobSample</a>
    <a href="?downloadBlobSample">downloadBlobSample</a>
    <a href="?listBlobsSample">listBlobsSample</a>
...
function uploadBlobSample(BlobRestProxy $blobClient)
{
